...
We frame EDRA's rule application as a contextual bandit: the context $x$ is a profile embedding, the action $a$ is one of three first-contact strategies, and the reward $r \in \{0,1\}$ indicates whether the recipient replied. We evaluate on 976 interactions extracted from a commercial CRM.
