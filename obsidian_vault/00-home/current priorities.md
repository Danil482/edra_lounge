...
Session 2026-05-30 (KNN threshold + silhouette) → [[../sessions/2026-05-30 KNN threshold and silhouette logging]]
...
- [ ] **Verify KNN `min_sim=0.35` threshold on 825 Pipedrive rows** — current value validated against 8 synthetic archetypes + 9 synthetic outliers (gap at 0.33–0.37). Rerun `select_rule_by_knn` similarity distribution on the full evaluation dataset once regenerated to confirm or adjust.
